...
public class DroidsSystem : MonoBehaviour
{
	...
	public void Create()
	{
		...
		for (byte i = 0; i<count; i++) {
			...
			GameObject prefab = (GameObject)Instantiate(Resources.Load("carrier"));
            ...
            DroidFly f = prefab.GetComponent<DroidFly>();
