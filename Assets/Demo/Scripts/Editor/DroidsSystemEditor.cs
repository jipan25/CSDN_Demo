...
[CustomEditor (typeof(DroidsSystem))]
public class DroidsSystemEditor : Editor {
	...
	public override void OnInspectorGUI()
	{
		...
		{
			count.intValue 			= Random.Range(5,DroidsSystem.FLY_COUNT_LIMIT);
            radius.floatValue = Random.Range(1f, DroidsSystem.RADIUS_LIMIT);
            updateTime.floatValue = Random.Range(0.1f, DroidsSystem.UPDATE_TIME_LIMIT);
            forwardSpeed.floatValue = Random.Range(0.5f, DroidsSystem.FORWARD_SPEED_LIMIT);
            angularSpeed.floatValue = Random.Range(0.5f, DroidsSystem.ANGULAR_SPEED_LIMIT);
		}
		...
		*/
        ...
        EditorGUILayout.IntSlider(count, 1, DroidsSystem.FLY_COUNT_LIMIT, "Flies Count");
        EditorGUILayout.Slider(radius, 1f, DroidsSystem.RADIUS_LIMIT);

        EditorGUILayout.Slider(disableDistance, 1f, DroidsSystem.DISABLE_LIMIT);
		EditorGUILayout.BeginHorizontal();
        ...
        EditorGUILayout.Slider(updateTime, 0.1f, DroidsSystem.UPDATE_TIME_LIMIT);
        ...
        EditorGUILayout.Slider(forwardSpeed, 0.5f, DroidsSystem.FORWARD_SPEED_LIMIT, "Forward Speed");
        EditorGUILayout.Slider(angularSpeed, 0.5f, DroidsSystem.ANGULAR_SPEED_LIMIT, "Angular Speed");
